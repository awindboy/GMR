...
def load_robot_motion(motion_file):
    ...
    with open(motion_file, "rb") as f:
        ...
        raw_root_rot = motion_data["root_rot"]
        if "robot_root_rot" in motion_data:
            raw_root_rot = motion_data["robot_root_rot"]
        motion_root_rot = raw_root_rot[:, [3, 0, 1, 2]] # from xyzw to wxyz
